...
type UpcomingGamesPageLayoutProps = {
  ...
  title: ReactNode
  /** Optional feed freshness metadata shown under the title. */
  subtitle?: ReactNode
 ...
 */
export function UpcomingGamesPageLayout({ title, subtitle, scope, children }: UpcomingGamesPageLayoutProps) {
  return (
