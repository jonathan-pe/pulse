      ...
      <div className='container max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8'>
        <div className='mb-6 sm:mb-8'>
          <h1 className='text-2xl sm:text-3xl font-bold mb-2 flex items-center gap-3'>
            <Users className='h-6 w-6 sm:h-8 sm:w-8 text-muted-foreground' aria-hidden />
            Community
          </h1>
          <p className='text-muted-foreground'>
            See how other predictors are doing lately—same points rules for everyone, shown for context.
          </p>
        </div>
